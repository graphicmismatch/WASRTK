...
class WASRTK {
    ...
    setupEventListeners() {
        ...
        document.getElementById('selectionFeatherSlider').addEventListener('input', (e) => {
            selectionFeather = Math.max(0, Math.min(10, parseInt(e.target.value, 10) || 0));
        ...
        const handleCanvasInteractionMove = (e) => {
            ...
            this.updatePolygonHoverPreview(e);
    ...
    applyFeatherToImageData(imageData, radius) {
    ...
    createLassoSelectionFromPoints(points) {
        ...
        selectionImageData = this.applyFeatherToImageData(selectionImageData, selectionFeather);
    ...
    startSelectionInteraction(coords) {
        ...
        if (selectionMode === 'polygon') {
            if (!selectionInteraction || selectionInteraction.mode !== 'polygon') {
                activeSelection = null;
                selectionInteraction = {
                    mode: 'polygon',
                    points: [coords],
            ...
            this.drawLassoPreview(points, coords);
            return;
        }
    ...
    finishSelectionInteraction() {
        ...
        if (selectionInteraction.mode === 'select') {
            ...
            this.createLassoSelectionFromPoints(selectionInteraction.points || []);
        } else if (selectionInteraction.mode === 'polygon') {
            this.drawLassoPreview(selectionInteraction.points || [], selectionInteraction.current);
            return;
