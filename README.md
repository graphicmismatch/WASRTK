...
- [x] Add Phase 1 interaction bug audit covering remaining tool, selection, transform, fill, and project UX issues. **Done**
...
- [x] Add adjustment layers (levels, curves, hue/saturation, brightness/contrast). **Done**
- [x] Add clipping masks and alpha-lock workflows for targeted painting. **Done**
- [x] Add smart guides, rulers, and snapping for precise layout alignment. **Done**
...
- [Component Architecture](./docs/architecture/components.md) — full file-by-file inventory
- [Drawing Tools](./docs/features/drawing-tools.md)
- [Palette Editor](./docs/features/palette-editor.md)
